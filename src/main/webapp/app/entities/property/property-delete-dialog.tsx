...
export const PropertyDeleteDialog = (props: IPropertyDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="jhipsterSampleMongoApp.property.delete.question">
        <Translate contentKey="jhipsterSampleMongoApp.property.delete.question" interpolate={{ id: propertyEntity.id }}>
