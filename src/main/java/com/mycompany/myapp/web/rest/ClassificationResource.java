...
/**
 * REST controller for managing {@link com.mycompany.myapp.domain.Classification}.
 */
@RestController
@RequestMapping("/api")
public class ClassificationResource {
    ...
    public ResponseEntity<ClassificationDTO> getClassification(@PathVariable String id) {
